...
# Your legal name
first_name = "Carlos"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "German"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Rodriguez"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "1133773628"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Buenos Aires"                  # Los Angeles, San Francisco, etc.
'''
